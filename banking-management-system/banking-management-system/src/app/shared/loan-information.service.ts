...
////////////////
  getAllLoanInformation(): Observable<LoanInformation[]> {
    return this.http.get<LoanInformation[]>(`${this.baseUrl}/loanInformation`);
  }

  saveLoanInformation(loanInformation: LoanInformation): Observable<LoanInformation> {
    return this.http.post<LoanInformation>(`${this.baseUrl}/loanInformation`, loanInformation);
  }
/////////////
